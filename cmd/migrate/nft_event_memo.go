...
var MigrationNftEventMemoCommand = &cobra.Command{
	Use:   "nft-event-memo",
	Short: "Setup memo column in nft_event table",
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		defer conn.Release()
		return parallel.MigrateNftEventMemo(conn, batchSize)
	},
}

func init() {
	MigrationNftEventMemoCommand.PersistentFlags().Uint64(
		CmdBatchSize,
		1000,
